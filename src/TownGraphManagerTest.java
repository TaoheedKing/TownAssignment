...
public class TownGraphManagerTest {
	...
	public void testGetPath() {
		ArrayList<String> path = graph.getPathSets(town[1],town[11]);
		  assertNotNull(path);
	...
	public void testGetPathA() {
		ArrayList<String> path = graph.getPathSets(town[1],town[10]);
		  assertNotNull(path);
		  assertTrue(path.size() > 0);
	...
	public void testGetPathB() {
		ArrayList<String> path = graph.getPathSets(town[1],town[6]);
		  assertNotNull(path);
		  assertTrue(path.size() > 0);
		  assertEquals("Town_1 via Road_2 to Town_3 4 miles",path.get(0).trim());
		  assertEquals("Town_3 via Road_5 to Town_8 2 miles",path.get(1).trim());
